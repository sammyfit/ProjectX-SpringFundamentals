...
public class EmployeeClientImpl implements EmployeeClient {
    ...
    public List<EmployeeDTO> getAllEmployees() {
        log.trace("Trying to Reterive All Employees in getAllEmployees");
        try{
    ...
    public EmployeeDTO getEmployeeById(Long employeeId) {
        log.trace("Trying to Reterive All Employees in getEmployeeById");
        try{
    ...
    public EmployeeDTO createNewEmployee(EmployeeDTO employeeDTO) {
       ...
       try{
           ...
           log.trace("Retrieved Employee List in getAllEmployees: {}",employeeDTOApiResponse.getBody());
